    ...
    return MultiProvider(
      ...
      child: Consumer<DarkModeProvider>(
        ...
        return MaterialApp(
          ...
          theme: ThemeData(
            drawerTheme: DrawerThemeData(backgroundColor: darkModeConsumer.isDark?
...
class _ScreenRouterState extends State<ScreenRouter> {
  ...
  void initState() {
    Provider.of<DarkModeProvider>(context, listen: false).getMode();
        Provider.of<AuthProvider>(context, listen: false).checkIsAuthentecated();
    super.initState();
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<AuthProvider>(builder: (context, aa , chaild){
        return  aa.isAuthenticeted ? const HomeScreen  () : const LoginScreen();
      });
  }
}
