...
class GamesProvider with ChangeNotifier {
  ...
  fetchAllGamesFromApi() async {
    setLoading(true);
    var response =
        await api.get("https://www.freetogame.com/api/games", {});
        // http.get(Uri.parse("https://www.freetogame.com/api/games"));
  ...
  fetchGamesByPlatform(String p) async {
    ...
    var response = await api.get("https://www.freetogame.com/api/games?platform=$p", {});
    // http
